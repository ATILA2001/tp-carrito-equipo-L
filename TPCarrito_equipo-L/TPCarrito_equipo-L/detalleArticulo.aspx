	...
	<div id="carouselExample" class="carousel slide">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="<%:lista[0] %>" class="max-width: 10px; max-height: 10px; display: block; float: right; margin-right: 10px;" alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%:lista[1] %>" class="max-width: 10px; max-height: 10px; display: block; float: right; margin-right: 10px;" alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%:lista[2] %>" class="max-width: 10px; max-height: 10px; display: block; float: right; margin-right: 10px;" alt="...">
			</div>
		</div>
